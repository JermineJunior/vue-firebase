    ...
    <div class="px-12 mx-auto max-w-7xl">
      <div class="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
        ...
        <div class="mb-4 space-x-0 md:space-x-2 md:mb-8">
          <RouterLink to="/login"
            class="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg bg-primary text-white rounded-2xl mr-3 sm:w-auto sm:mb-0">
            Get Started
          ...
          <RouterLink to="/about"
            class="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg bg-gray-200 text-blue-700 rounded-2xl sm:w-auto sm:mb-0">
            Learn More
